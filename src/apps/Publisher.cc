...
void PublisherApp::initialize(int stage)
{
    ...
    {
        // If variables are read from the ini-file and used here from start,
        // initialise them here using: variable = par("variable");
    }
}
...
void PublisherApp::sendPacket()
{
    ...
    payload->addTag<PublisherTimeTag>()->setPublisherTime(startTimePublish); // This is used to calculate the custom end-to-end latency
...
void PublisherApp::processStart()
{
    ...
    // This is edited in this version
